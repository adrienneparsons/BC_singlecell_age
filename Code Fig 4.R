...
# Load the cellchat objects previously generated by the BC data_CellChat_allobjects_psize script
# The RDATA files can be downloaded from Dropbox > McLab lab meeting 2020 > Esther Sauras Colon > CellChat files
# Create an object list
# DO A SEPARATE ANALYSIS FOR TNBC AND ER

#--------------------------------------------------------------------------------------------------------------------------------
# TNBC
cellchatTNBC.young <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/cellchatTN.young_computeCommunProb_psize_TRUE_celltype_major.Rdata")
cellchatTNBC.old <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/cellchatTN.old_computeCommunProb_psize_TRUE_celltype_major.Rdata")
object.list <- list(TNBC.young = cellchatTNBC.young, TNBC.old = cellchatTNBC.old)

# ER
cellchatER.young <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/cellchatER.young_computeCommunProb_psize_TRUE_celltype_major.Rdata")
cellchatER.old <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/cellchatER.old_computeCommunProb_psize_TRUE_celltype_major.Rdata")
...
#--------------------------------------------------------------------------------------------------------------------------------
# TNBC
cellchatTNBC.young <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/RData/cellchat_files/cellchatTN.young_computeCommunProb_psize_TRUE.Rdata")
cellchatTNBC.old <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/RData/cellchat_files/cellchatTN.old_computeCommunProb_psize_TRUE.Rdata")
object.list <- list(TNBC.young = cellchatTNBC.young, TNBC.old = cellchatTNBC.old)

# ER
cellchatER.young <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/RData/cellchat_files/cellchatER.young_computeCommunProb_psize_TRUE.Rdata")
cellchatER.old <- readRDS("C:/Users/esthe/Desktop/PhD/BWH/RData/cellchat_files/cellchatER.old_computeCommunProb_psize_TRUE.Rdata")
object.list <- list(ER.young = cellchatER.young, ER.old = cellchatER.old)
#--------------------------------------------------------------------------------------------------------------------------------
...
# liftCellchat() if necessary (remove the code comment for ER young)
